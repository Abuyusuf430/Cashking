...
<br>
    ...
    <br>
        ...
        <!--  <div id="container1">
                    <div class="col-lg-4">
                      <div class="common_input mb_15">
                        <h5 class="form-control-label" for="input-first-name">Yodo1 App Key:- </h5>
                      </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="common_input mb_15">
                    <input style="background: #f5f6ff;" type="text" name="yodo_app_key" class="form-control" placeholder="Enter yodo1 app key" value="<?php echo $row['yodo_app_key']; ?>">
                    </div>
                    </div>
         </div>-->
              ...
              <div class="col-lg-4">
                  ...
                  <?php if ($row['rewarded_ad_type']=="applovin") {
                    echo '<option value="applovin">Applovin Max</option>
                          ...
                          /*
                          <option value="consoliads">Consoliads</option>
                          <option value="yodo">Yodo1</option>*/
                  ...
                  /*else if($row['interstital_ad_type'] == 'consoliads'){
                    echo '<option value="consoliads">Consoliads</option>
                          <option value="chartboost">Chartboost</option>
                          <option value="vungle">Vungle</option>
                          <option value="iron_source">ironSource</option>
                          <option value="adcolony">Adcolony</option>
                          ...
                          <option value="applovin">Applovin Max</option>
                          <option value="yodo">Yodo1</option>';
                  } else if($row['interstital_ad_type'] == 'yodo'){
                    echo '<option value="yodo">Yodo1</option>
                          <option value="consoliads">Consoliads</option>
                          <option value="chartboost">Chartboost</option>
                          <option value="vungle">Vungle</option>
                          <option value="iron_source">ironSource</option>
              ...
              <div class="col-lg-4">
                 ...
                 <input style="background: #f5f6ff;" type="number" name="spin_count_per_day" class="form-control" placeholder="Enter count" value="<?php echo $row['spin_count_per_day']; ?>">
                  ...
                  <!--  <div id="container1">
                    <div class="col-lg-4">
                      <div class="common_input mb_15">
                        <h5 class="form-control-label" for="input-first-name">Items between native ads:- </h5>
                      </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="common_input mb_15">
                   <input style="background: #f5f6ff;" type="number" name="native_count" class="form-control" placeholder="Enter native ad count" value="<?php echo $row['native_count']; ?>">
                    </div>
                    </div>-->
  </div>
  <hr>
     ...
     <div class="col-lg-4">
              <div class="common_input mb_15">
                ...
                <select class="form-control" name="banner_ad_type">
                  ...
                  /*else if($row['banner_ad_type'] == 'consoliads'){
                    echo '<option value="consoliads">Consoliads</option>
                          <option value="chartboost">Chartboost</option>
                          <option value="vungle">Vungle</option>
                          <option value="iron_source">ironSource</option>
                          ...
                          <option value="applovin">Applovin Max</option>
                          <option value="yodo">Yodo1</option>';
                  } else if($row['banner_ad_type'] == 'yodo'){
                    echo '<option value="yodo">Yodo1</option>
                          <option value="consoliads">Consoliads</option>
                          <option value="chartboost">Chartboost</option>
                          <option value="vungle">Vungle</option>
    ...
    <div class="col-lg-12">
      <div class="common_input mb_15">
        ...
        <input style="background: #f5f6ff;" type="text" name="vungle_interstital_id" class="form-control" placeholder="Enter vungle interstital id" value="<?php echo $row['vungle_interstital_id']; ?>">
            ...
            <!-- <div class="col-lg-3">
              <div class="common_input mb_15">
                <h4 class="form-control-label" for="input-first-name"><b>Native Ads</b></h4>
                <select class="form-control" name="native_ad_type">
                  <?php if ($row['native_ad_type']=="applovin") {
                    echo '<option value="applovin">Applovin Max</option>
                          <option value="chartboost">Chartboost</option>
                          <option value="consoliads">Consoliads</option>
                          <option value="yodo">Yodo1</option>';
                  } else if($row['native_ad_type'] == 'chartboost'){
                   echo '<option value="chartboost">Chartboost</option>
                          <option value="applovin">Applovin Max</option>
                          <option value="consoliads">Consoliads</option>
                          <option value="yodo">Yodo1</option>';
                  } else if($row['native_ad_type'] == 'consoliads'){
                   echo '<option value="consoliads">Consoliads</option>
                          <option value="applovin">Applovin Max</option>
                          <option value="chartboost">Chartboost</option>
                          <option value="yodo">Yodo1</option>';
                  } else if($row['native_ad_type'] == 'yodo'){
                    echo '<option value="yodo">Yodo1</option>
                          <option value="applovin">Applovin Max</option>
                          <option value="chartboost">Chartboost</option>
                          <option value="consoliads">Consoliads</option>';
                    ...
                    <div class="col-lg-12">
                      <div class="common_input mb_15">
                        <label class="form-control-label" for="input-email">Applovin native ad unit id</label>   
                        <input style="background: #f5f6ff;" type="text" name="applovin_native_id" class="form-control" placeholder="Enter applovin native id" value="<?php echo $row['applovin_native_id']; ?>">
                      </div>
                    </div>
                  </div>
            </div>-->
