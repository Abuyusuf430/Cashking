...
if (isset($c) && isset($access_key)) {
    $response = array(); 
    if ($key != $access_key) { 
        $response["\x65\x72\x72\x6f\x72"] = "\60"; 
        $response["\x6d\x65\163\163\141\x67\x65"] = "\111\156\x76\141\154\151\144\x20\x41\143\143\145\x73\x73\x20\x4b\145\x79";
        print_r(json_encode($response));
        return false; 
